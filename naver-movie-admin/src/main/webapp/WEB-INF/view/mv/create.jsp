...
$().ready(function() {
	...
	$("#btn-add-director, #btn-add-director, #btn-add-scripter, #btn-add-production, #btn-add-producer, #btn-add-mainActor, #btn-add-supportActor, #btn-add-extra").click(function() {
		console.log("감독 등록 버튼")
		var ppl = window.open("${context}/mvppl/search", "영화인검색", "width=500, height=500")
	});
